...
public class TestReflect3 {
	...
	public static void main(String[] args)throws Exception{
		...
		u.setUserName("aa");
		u.setUserLogin("aaa");
		Object ob = getGetMethod(u, "userName");
		System.out.println(ob);
		
		//test set
		UserPo person2 = new UserPo();
		String field2 = "userName";
		setValue(person2, person2.getClass(), field2, UserPo.class.getDeclaredField(field2).getType(), "汪汪");
		System.out.println(person2);
		//获取某个属性的类型
		System.out.println(UserPo.class.getDeclaredField("userName").getType());
